<template>
    ...
    <form class="form" @submit.prevent="submit" id="consultation-form">
      <div class="flex">
        <label>
      ...
      <input type="hidden" class="input" v-model="form.petspecies_id" name="petspecies_id" placeholder="Pet Category">
