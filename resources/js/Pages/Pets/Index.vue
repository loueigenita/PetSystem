    ...
    <div class="min-h-screen">
      <div class="container py-3 mx-auto">
        <div class="d-flex justify-content-between align-items-center mb-6">
          <h1 class="text-4xl font-bold">All PETS</h1>
          <div>
            <Link
              class="btn btn-primary btn-sm px-4 py-2 font-bold rounded hover:bg-blue-700"
                ...
                <tr v-for="pet in pets.data" :key="pet.id" class="border-bottom border-gray-200">
                  ...
                  <td class="text-center">
                    <Link :href="`/pets/edit/${pet.id}`">
                      <button class="btn btn-success btn-sm mx-2 hover:bg-green-700">
                        <i class="fas fa-pen"></i>
                      </button>
                    </Link>
                    <button
                      class="btn btn-danger btn-sm hover:bg-red-700"
